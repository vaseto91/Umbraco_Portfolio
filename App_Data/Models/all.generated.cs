...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "5cfdd58f1be92f15")]
...
#pragma warning restore 0109
		...
		public string Icons
		{
			get { return this.GetPropertyValue<string>("icons"); }
		}
		...
		/// Content
		///</summary>
		[ImplementPropertyType("repeatableText")]
		public IEnumerable<string> RepeatableText
		{
			get { return this.GetPropertyValue<IEnumerable<string>>("repeatableText"); }
		}
		...
		{
			get { return this.GetPropertyValue<IEnumerable<string>>("title"); }
		}

		///<summary>
		/// WellcomeMsg
		///</summary>
		[ImplementPropertyType("wellcomeMsg")]
...
#pragma warning restore 0109
	...
	public partial class Test1 : PublishedContentModel
	{
#pragma warning disable 0109 // new is redundant
